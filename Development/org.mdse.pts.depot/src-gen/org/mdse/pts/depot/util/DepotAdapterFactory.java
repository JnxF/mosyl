...
public class DepotAdapterFactory extends AdapterFactoryImpl {
	...
	protected DepotSwitch<Adapter> modelSwitch =
		new DepotSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDinnerCoach(DinnerCoach object) {
				return createDinnerCoachAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.mdse.pts.depot.DinnerCoach <em>Dinner Coach</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDinnerCoachAdapter() {
		return null;
	}
