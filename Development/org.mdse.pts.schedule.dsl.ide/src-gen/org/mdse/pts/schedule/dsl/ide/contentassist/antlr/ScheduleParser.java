...
public class ScheduleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScheduleGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTrainScheduleAccess().getGroup_4(), "rule__TrainSchedule__Group_4__0");
			builder.put(grammarAccess.getTrainScheduleAccess().getGroup_4_0(), "rule__TrainSchedule__Group_4_0__0");
			...
			builder.put(grammarAccess.getMiddleSpotAccess().getGroup_4(), "rule__MiddleSpot__Group_4__0");
			builder.put(grammarAccess.getMiddleSpotAccess().getGroup_6(), "rule__MiddleSpot__Group_6__0");
			...
			builder.put(grammarAccess.getTrainScheduleAccess().getDateTimesAssignment_3(), "rule__TrainSchedule__DateTimesAssignment_3");
			builder.put(grammarAccess.getTrainScheduleAccess().getDateTimesAssignment_4_0_1(), "rule__TrainSchedule__DateTimesAssignment_4_0_1");
			builder.put(grammarAccess.getTrainScheduleAccess().getDateTimesAssignment_4_2(), "rule__TrainSchedule__DateTimesAssignment_4_2");
			builder.put(grammarAccess.getTrainScheduleAccess().getRouteAssignment_6(), "rule__TrainSchedule__RouteAssignment_6");
			...
			builder.put(grammarAccess.getRouteAccess().getStartSpotAssignment_0(), "rule__Route__StartSpotAssignment_0");
			builder.put(grammarAccess.getRouteAccess().getMiddleSpotsAssignment_1(), "rule__Route__MiddleSpotsAssignment_1");
			builder.put(grammarAccess.getRouteAccess().getFinalSpotAssignment_2(), "rule__Route__FinalSpotAssignment_2");
			...
			builder.put(grammarAccess.getMiddleSpotAccess().getWaitingTimeAssignment_4_1(), "rule__MiddleSpot__WaitingTimeAssignment_4_1");
			builder.put(grammarAccess.getMiddleSpotAccess().getTurnStationAssignment_5(), "rule__MiddleSpot__TurnStationAssignment_5");
			builder.put(grammarAccess.getMiddleSpotAccess().getLegAssignment_6_2(), "rule__MiddleSpot__LegAssignment_6_2");
